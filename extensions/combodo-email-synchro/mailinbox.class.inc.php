...
abstract class MailInboxBase extends cmdbAbstractObject
{
	...
	public static function Init()
	{
		...
		// SSL
		MetaModel::Init_AddAttribute(new AttributeEnum("ssl", array("allowed_values"=>new ValueSetEnum('ssl'), "sql"=>"ssl", "default_value"=>null,"is_null_allowed"=>true, "depends_on"=>array())));
