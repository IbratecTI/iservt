...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:IPAddress/Tab:DatacenterDevice' => 'Dispositivos (%1$s)',
	'Class:IPAddress/Tab:DatacenterDevice+' => 'Lista de Dispositivos utilizando este IP como seu IP de gerenciamento: %1$s',
	'Class:IPAddress/Tab:VirtualMachine' => 'Virtual Machines (%1$s)',
	'Class:IPAddress/Tab:VirtualMachine+' => 'Lista de VMs utilizando este IP como seu IP de gerenciamento: %1$s',
        'Class:IPAddress/Tab:PC' => 'PC (%1$s)',
        'Class:IPAddress/Tab:PC+' => 'Lista de PCs utilizando este IP como seu IP de gerenciamento: %1$s',
        'Class:IPAddress/Tab:Printer' => 'Impressoras (%1$s)',
        'Class:IPAddress/Tab:Printer+' => 'Lista de Impressoras utilizando este IP como seu IP de gerenciamento: %1$s',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	'Menu:IPManagement' => 'Gerenciamento IP',
	'Menu:IPManagement+' => 'Gerenciamento IP',
