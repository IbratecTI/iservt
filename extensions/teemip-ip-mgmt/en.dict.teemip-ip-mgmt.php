...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:IPAddress/Tab:VirtualMachine+' => 'List of Virtual Machines using this IP as their management IP: %1$s',
        'Class:IPAddress/Tab:PC' => 'PC Devices (%1$s)',
	'Class:IPAddress/Tab:PC+' => 'List of PC Devices using this IP as their management IP: %1$s',
        'Class:IPAddress/Tab:Printer' => 'Printer Devices (%1$s)',
	'Class:IPAddress/Tab:Printer+' => 'List of Printer Devices using this IP as their management IP: %1$s',
